...
class FinishInventoryDocsTests(unittest.TestCase):
    ...
    def test_completion_audit_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("Moving-head verification procedure", audit)
        self.assertIn("git rev-parse HEAD", audit)
        self.assertIn("gh run list --repo", audit)
        self.assertIn("do not rely on pinned moving-head hashes", audit)
        ...
        self.assertNotIn("current verified `main` head is", audit)
        self.assertIn("implementation checkpoint", audit)
    ...
    def test_finish_inventory_names_latest_implementation_checkpoint(self) -> None:
        ...
        self.assertIn("Moving-head verification", inventory)
        self.assertIn("git rev-parse HEAD", inventory)
        self.assertIn("gh run list --repo", inventory)
        self.assertIn("Do not treat a hard-coded", inventory)
        ...
        self.assertIn("Product or workflow commits after this inventory", inventory)
        ...
        self.assertNotIn("Current verified `main` head is", inventory)
