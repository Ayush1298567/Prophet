        ...
        <div className="gate-body">
          <div className="gate-detail-grid">
            <div className="gate-detail-row">
              ...
              <span className="gate-detail-val mono">localhost:8983 (Vulhub · sandboxed)</span>
            </div>
            <div className="gate-detail-row">
              <span className="gate-detail-key">CVE</span>
              <span className="gate-detail-val mono">CVE-2021-44228 — Log4Shell</span>
            </div>
            <div className="gate-detail-row">
            ...
            <div className="gate-detail-row">
              ...
              <span className="gate-detail-val">Nuclei probe — no shell, no persistence</span>
            </div>
            <div className="gate-detail-row">
              <span className="gate-detail-key">SCOPE</span>
              <span className="gate-detail-val">Isolated Docker network · no egress · ephemeral</span>
            </div>
          </div>
